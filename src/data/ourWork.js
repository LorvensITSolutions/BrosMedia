  ...
  items: [
    {
      ...
      description:
        'Logos, color systems, typography, and brand guidelines that give your business a consistent face across every touchpoint.',
      layout: 'brand-identity',
      portraitImage:
        'https://res.cloudinary.com/dvruqkpqk/image/upload/v1783663715/Rectangle_69_ugl4hy.png',
      portraitAlt: 'Brand identity portrait layout',
      landscapeImage:
        'https://res.cloudinary.com/dvruqkpqk/image/upload/v1783663716/Rectangle_70_ttgdpp.png',
      landscapeAlt: 'Brand identity landscape layout',
    ...
    },
    {
      ...
      mobileImage:
        'https://res.cloudinary.com/dvruqkpqk/image/upload/v1781245717/Screenshot_2026-06-12_115823_kswhzc.png',
      imageAlt: 'Website design on desktop and mobile',
    },
    {
      id: 'social-media',
      title: 'Social media management',
      description:
        'Full account handling, content calendars, and consistent posting so your brand stays active and on-message without the daily scramble.',
      layout: 'transparent',
      image:
        'https://res.cloudinary.com/dvruqkpqk/image/upload/v1783676701/Group_1597880398_1_gwgx3c.png',
      imageAlt: 'Social media analytics on mobile devices',
    },
    {
      id: 'meta-ads',
      ...
      gridImages: [
        'https://res.cloudinary.com/dvruqkpqk/image/upload/v1783677247/Screenshot_2026-07-07-17-53-57-27_1c337646f29875672b5a61192b9010f9.jpg_1_sbw66p.png',
        'https://res.cloudinary.com/dvruqkpqk/image/upload/v1783677247/Screenshot_2026-07-07-17-54-47-95_1c337646f29875672b5a61192b9010f9.jpg_1_lmep8z.png',
        'https://res.cloudinary.com/dvruqkpqk/image/upload/v1783677247/Screenshot_2026-07-07-17-55-12-63_1c337646f29875672b5a61192b9010f9.jpg_1_spi8vl.png',
      ],
      imageAlt: 'Meta ad campaigns on mobile',
    },
    {
      ...
      cards: [
        ...
        'https://res.cloudinary.com/dvruqkpqk/image/upload/v1783678422/Group_1597880401_gffsr9.png',
      ],
      imageAlt: 'Creative production campaign dashboards',
    },
    {
      id: 'print-collateral',
      title: 'Brochures & Print Collateral',
      description:
        'Sales brochures, catalogs, print-ready and digital marketing materials.',
      layout: 'print-collateral',
      leftImage:
        'https://res.cloudinary.com/dvruqkpqk/image/upload/v1783679222/GoClean_Brochure_5655_1_kprcfd.png',
      rightImage:
        'https://res.cloudinary.com/dvruqkpqk/image/upload/v1783679221/AMVI_BROCHURE_Final_1_page-0001_1_q3nknr.png',
      imageAlt: 'Brochure and print collateral designs',
    },
    {
      id: 'video-production',
      ...
      imageAlt: 'Video production on set',
    },
    {
      id: 'app-ui',
    ...
    },
    {
      ...
      imageAlt: 'Political portfolio website on desktop and mobile',
    },
  ],
}
